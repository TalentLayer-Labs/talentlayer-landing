  ...
  return (
    <section className="bg-base-content py-24 text-base-100">
      <Container className="flex flex-col items-start gap-6">
        ...
        TalentLayer enables workers and hirers to grow one unified and user-owned reputation across all integrated platforms. <a className="text-primary">this is possible thanks to blockchain technology</a> - work history, reviews, and transactions are stored on-chain at the network level.
        </p>
        <p className="text-base-100/80">
        ...
        <div className="flex flex-col gap-4 min-[500px]:flex-row">
            ...
            <a href="https://medium.com/talentlayer/the-business-case-for-breaking-down-silos-3d3952cde260" target="_blank" rel="noreferrer" className="flex-1">
