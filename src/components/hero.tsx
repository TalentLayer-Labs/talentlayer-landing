    ...
    <section className="relative">
      <Container className="relative flex flex-col items-center gap-20 py-40 md:flex-row">
        <div className="flex flex-col gap-10 order-2">
          <h1 className="text-6xl font-bold">building <a className="underline text-primary">work tech</a> doesn't have to be<a className="text-6xl font-bold text-primary"><a className="italic">hard work</a>.</a></h1>
